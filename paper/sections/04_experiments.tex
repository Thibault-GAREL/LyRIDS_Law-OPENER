...
\begin{tablenotes}[flushleft]
\scriptsize
\item[$\dagger$] \rev{The first two columns are shares of the \emph{gold} mentions, whereas \emph{acc.} is a share of the mentions \emph{already detected}, so their denominators differ.}
