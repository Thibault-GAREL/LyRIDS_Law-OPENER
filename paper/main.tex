...
%\newcommand{\rev}[1]{\textcolor{red}{#1}}   % <-- version de relecture, revisions en rouge
\newcommand{\rev}[1]{#1}                     % <-- VERSION A SOUMETTRE, tout en noir

% Valeur en attente d'un run. Volontairement criarde : le PDF final ne doit
% plus en contenir aucune. Verifier avec :  grep -rn "tbd" paper/sections/
...
% Auteurs et affiliation repris du papier journal OPENER.
% Regles ACL : prenoms complets (pas d'initiales), pas de NOM en capitales,
% pas de footnote pour l'affiliation. L'ordre et l'orthographe doivent
% coincider avec ce qui est saisi dans OpenReview.
\author{
  Thibault Garel \quad Faiza Belbachir \quad Assia Soukane \\
  LyRIDS, ECE Engineering School, Paris, 75015, France \\
  \small\texttt{garel.thibault14@gmail.com} \quad
  \small\texttt{fbelbachir@ece.fr} \quad
  \small\texttt{assia.soukane@ece.fr}
}
