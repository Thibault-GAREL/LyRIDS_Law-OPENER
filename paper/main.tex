...
% --- REVISION MARKUP (2026-08) ------------------------------------------------
% Reframing: OPENER is presented as designed for the legal domain first, the
% general-domain study becoming the follow-up. Every rewritten passage is wrapped
% in \rev{} and printed in red. To produce a clean PDF, redefine it as
%   \DeclareRobustCommand{\rev}[1]{#1}
\definecolor{revred}{HTML}{CC0000}
\DeclareRobustCommand{\rev}[1]{\textcolor{revred}{#1}}
% -----------------------------------------------------------------------------
...
% The system is no longer framed as a legal variant of a general-domain pipeline,
% so it drops the "-Legal" suffix and keeps its own name.
\title{\rev{OPENER}: A Frugal Open-World NER Pipeline for the Legal Domain}
