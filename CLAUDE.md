...
- Frugalité e2e (mesurée sur le released, énergie **normalisée par 1000 phrases** depuis le 2026-07-29) : Sup 84 ms / 1.7 Wh, ZS 133 ms / 2.7 Wh ; 1 à 2 ordres de grandeur sous GNER (8.3 s, 96 Wh) et Qwen int4 (5.4 s, 100 Wh, le plus gourmand par phrase une fois normalisé).
